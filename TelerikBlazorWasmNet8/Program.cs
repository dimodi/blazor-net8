...
using TelerikBlazorWasmNet8.Client.Pages;
using TelerikBlazorWasmNet8.Components;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(TelerikBlazorWasmNet8.Client._Imports).Assembly);
